...
def parse_args():
    ...
    parser.add_argument("sys_filename", type=str, help="System input filename")
    parser.add_argument("trj_filename", type=str, help="Trajectory filename")
    parser.add_argument("step", type=int, help="Step to extract")
