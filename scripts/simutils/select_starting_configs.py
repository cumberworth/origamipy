...
def parse_args():
    ...
    parser.add_argument(
        "sim_filebase", type=str, help="Filebase of simulation to select configs from"
    )
    parser.add_argument(
        "out_filebase", type=str, help="Filebase of starting config trj files"
    )
    parser.add_argument("ext", type=str, help="Starting config trj file extension")
