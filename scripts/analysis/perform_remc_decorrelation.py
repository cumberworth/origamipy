...
def main():
    ...
    for rep in range(args.reps):
        rep_sim_collections = outputs.create_sim_collections(
            filebase, all_conditions, rep, use_mod_ops=True
        )
...
def parse_args():
    ...
    parser.add_argument("skip", type=int, help="Number of steps to skip on read")
    ...
    parser.add_argument(
        "--sample", type=int, default=None, help="Statistical inefficiency"
    )
