...
def main():
    ...
    aligned_positions, rmsds = config_process.align_positions(traj_file, ref_config)
...
def parse_args():
    ...
    parser.add_argument(
        "traj_filename", type=str, help="Configurations file to calculate RMSD on"
    )
    parser.add_argument(
        "ref_filename", type=str, help="Configurations file containing reference"
    )
    parser.add_argument(
        "step", type=int, help="Step containing reference configuration"
    )
